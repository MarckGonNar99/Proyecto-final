...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-02-2023 a las 10:50:48
...
(5, 3, 'Salmón asado', 'imagenes/recetas/Salmónasado_3.jpg', 20, 'Pescado y mariscos', '2 filetes de salmón, aceite, perejil, salsa mostaza con grano, sal', NULL, 'Preparar bandeja de horno con papel vegetal, con un pincel recubrir una capa de aceite donde se ponga el salmón. Poner el salmón en la bandeja y pintar con el pincel sobre ellos la salsa mostaza. Luego esparcir la sal y el perejil al gusto. Hornear 15 minutos a 175 ºC fuego arriba y abajo con ventilación', '2023-02-15', 0),
(11, 8, 'Pollo al vino', 'imagenes/recetas/Polloalvino_11.png', 90, 'Carnes y aves', '1 pollo de 1500g, sal, 1 cucharada de salsa de tomate, 1 diente de ajo, medio cubito de caldo de pollo, 1 cebolla, aceite, tomillo, 400ml de vino tinto, laurel, 100g de panceta ahumada, 12 cebollas francesas, 175g de champiñones, 4 cucharadas de coñac', NULL, 'Cuartear el pollo y reservar. Poner los menudillos en un cazo de agua; añadir el caldo, la salsa de tomate y la cebolla cortada. Salar y cocer 30 minutos. Escurrir y reservar el liquido. Poner el ajo, pelado y troceado, en un cazo a fuego medio 15 min. Pelar las cebollas, dorarlas en aceite, junto a la panceta en tiras. Sazonar el pollo con la piel hacia abajo y freírlo 2 minutos. Ponerlo en una cazuela, flamear coñac y añadir la panceta y las cebollitas. Colar el vino sobre el pollo, añadir caldo, tapar y hervir 40 min. Agregar los champiñones; sacar el pollo y colocarlo junto a las cebollitas y la panceta. Servir', '2023-02-15', 0),
(13, 5, 'Sopa de cebolla', 'imagenes/recetas/Sopadecebolla_13.png', 60, 'Sopas, cremas y cocidos', '600d de cebollas, 70g de aceite, 1 cucharada de harina, 100g de queso rallado, 15 rebanadas finas de pan, pimienta blanca molida, sal', NULL, 'Pelar y picar las cebollas; rehogarlas en la satén a fuego lento hasta que estén transparentes y blandas pero sin dorarse. Sazonar con sal y pimienta. Cuando estén casi desechas, agregar la harina y remover hasta obtener una mezcla dorada. Poner esta preparación en una cacerola y verter un cuarto de litro de agua fría. Dejar cocer 40 min a fuego medio-suave. Freír las rebanadas de pan con aceite; escurrirlas y reservarlas. Calentar el horno a temperatura media-alta. Preparar cuencos individuales', '2023-01-30', 1),
...
(16, 5, 'Albóndigas en salsa', 'imagenes/recetas/Albóndigasensalsa_16.png', 100, 'Carnes y aves', '600g de carne de ternera picada, 2 huevos, 1 zanahoria, 1 cebolla pequeña, 30g de piñones, 50g de pasas sin pepitas, 5 cucharadas de pan rallado, 2 cucharadas de harina, aceite, 1/2L de caldo de carne, 1 vaso de vino blanco, mostaza, sal y pimienta', NULL, 'Colocar la carne en una hondilla y añadirle los huevos batidos, la cebolla, perejil, zanahoria muy picada, sal, los piñoes y las pasas previamente remojadas una hora en agua. Añadir 3 cucharadas de pan rallado para hacer una masa bien mezclada. Formar las albóndigas, pasarlas por el pan rallado y freírlas en el aceite puesto en una sartén al fuego. Colocarlas en una cacerola con un vaso de agua y 1/2 de vino blanco. Cocer 20 min y guardar al calor. Colocar aceite en una sartén e incorporar la harina. Remover hasta conseguir un color dorado. Agregar el caldo, el vino y dejar cocer 15 min. Sazonar al gusto y al final añadir una cucharadita de mostaza', '2023-01-30', 1),
(19, 4, 'Pollo asado', 'imagenes/recetas/Polloasado_4.jpg', 80, 'Carnes y aves', '1 pollo de 1200g a 1400g,\r\n3 lonchas de bacon finas,\r\n30g de manteca de cerdo,\r\n1 copita de vino blanco,\r\nsal', NULL, 'Limpiar t chamuscar el pollo; depojarlo del cuello y las patas amarillas.\r\nUntar con la manteca de cerdo bien repartida por la piel.\r\nSalar por dentro y fuera.\r\nAtarle 2 lonchas de bacon, una en la pechuga y otra en la espalda.\r\nPoner el pollo e una fuente de horno, calentar 10 min este y meter el pollo, asandolo a calor moderado media hora, dandole vueltas y regando con su jugo.\r\nAl terminar la media hora, sacarlo y rociarle el vino blanco y dejarlo asar otra media hora.\r\nYa tierno, despojarlo del hilo y el bacon (se tira) y reservarlo.\r\nQuitar la grasa de la salsa, añadir un poco de agua caliente.\r\nServir el pollo trinchado', '2023-02-15', 0),
(20, 3, 'rsgfsgfs', 'imagenes/recetas/rsgfsgfs_3.jpg', 23, 'Carnes y aves', 'gfgfgsgfsgf', NULL, 'gfsgsgfsfsgfsgfs', '2023-02-15', 0),
(21, 4, 'Coliflor con bechamel', 'imagenes/recetas/Coliflorconbechamel_21.png', 60, 'Verduras y legumbres', '1 coliflor grande, 100g de mantequilla, 50 g de harina, 1/2L de leche, queso rallado, nuez moscada, sal y pimienta', 'Quso', 'Trocear la coliflor y cocerla en agua con sal; escurrir y reservar. Fundir la mantequilla en un cazo, añadir la harina y mover; añadir poco a poco la leche caliente, batiendo con varillas para no formar grumos, sazonar con sal, pimienta y nuez moscada. Poner la coliflor bien escurrida en una fuente de horno, cubrir con la bechamel y espolvorear el queso rallado. Gratinar unos minutos a horno fuerte y scar cuando esté bien dorada toda la superficie. Servir muy caliente', '2023-02-15', 0);
...
INSERT INTO `reporte` (`id_reporte`, `id_user`, `id_receta`, `fecha`, `motivo`) VALUES
(4, 4, 20, '2023-02-15', 'Esto no es contenido de cocina. AVISO'),
(5, 3, 21, '2023-02-15', 'Pones Quso en vez de queso, alguien que pueda corregirlo');
...
(4, 'carlos', 'dc599a9972fde3045dab59dbd1ae170b', '../imagenes/usuarios/carlos_4.jpg'),
...
INSERT INTO `votacion` (`id_voto`, `id_user`, `id_receta`) VALUES
(16, 3, 16),
(15, 8, 13);
...
--
ALTER TABLE `receta`
  MODIFY `id_receta` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de la tabla `reporte`
--
ALTER TABLE `reporte`
  MODIFY `id_reporte` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `votacion`
  MODIFY `id_voto` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
